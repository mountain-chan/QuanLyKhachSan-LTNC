...
('The Light Hotel', N'79 Tran Cung, Quận Từ Liêm, Hà Nội', '0366918587', 15, N'Nằm ở quận Hoàn Kiếm, thuộc thành phố Hà Nội, The Light Hotel chỉ cách 300 m từ Nhà Thờ Lớn. Với các phòng nghỉ thanh lịch và hiện đại, khách sạn có hồ bơi ngoài trời cùng tầm nhìn ra vườn.', 0, 5, 2, 1, 1),
...
('Town House 23 Saigon', N'23 Dang Thi Nhu, Quận 2, TP. Hồ Chí Minh', '0366454787', 18, N'Chỉ cách Chợ Bến Thành nổi tiếng 300 m, Town House 23 Saigon cung cấp các phòng được bài trí trang nhã với phòng tắm riêng. Khách cũng được truy cập Wi-Fi miễn phí.', 1, 4, 3, 4, 8),
...
('OYO 403 Bao Quyen', N'35 Tran Hung Dao, Đà Nẵng, Việt Nam', '0366475187', 10, N'Khách sạn chỉ cách thành phố Đà Nẵng và Bãi biển Mỹ Khê nổi tiếng 2 km. Sân bay Quốc tế Đà Nẵng và Ga Đà Nẵng nằm ở vị trí thuận tiện cách nơi đây 3 km trong khi khách đi 30 km là tới Phố Cổ Hội An.', 1, 2, 3, 3, 1),
